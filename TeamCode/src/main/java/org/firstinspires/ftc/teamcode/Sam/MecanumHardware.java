...
public class MecanumHardware extends LinearOpMode
{
    ...
    public void godirection(float distance, float angle)
    {
        ...
        frontRight.setTargetPosition(distancefr);
        backRight.setTargetPosition(distancebr);
        frontLeft.setTargetPosition(distancefl);
        backLeft.setTargetPosition(distancebl);
