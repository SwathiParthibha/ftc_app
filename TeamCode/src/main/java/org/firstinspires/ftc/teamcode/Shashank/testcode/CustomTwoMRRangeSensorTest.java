...
@TeleOp(name = "CustomTwoMRRangeSensorTest", group = "MRI")
//@Disabled
public class CustomTwoMRRangeSensorTest extends OpMode {
    ...
    public void init() {
        ...
        rangeA = hardwareMap.i2cDevice.get("r1");
        rangeC = hardwareMap.i2cDevice.get("r2");

        rangeAreader = new I2cDeviceSynchImpl(rangeA, I2cAddr.create8bit(0x2a), false);
        rangeCreader = new I2cDeviceSynchImpl(rangeC, I2cAddr.create8bit(0x38), false);
