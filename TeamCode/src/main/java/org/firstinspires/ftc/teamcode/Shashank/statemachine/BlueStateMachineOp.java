 ...
 */
@Autonomous(name = "BlueStateMachineOp", group = "StateOps")
public class BlueStateMachineOp extends OpMode {
    ...
    public void init() {
        ...
        autoStateMachineBuilder.addLineFollow(telemetry, S.FOLLOW_lINE, S.PRESS_BEACON, leftMotor, rightMotor, lightSensor, rangeSensor);
        autoStateMachineBuilder.addPressBeacon(telemetry, S.PRESS_BEACON, S.STOP, leftMotor, rightMotor, leftColorSensor, rightColorSensor, BeaconColor.BLUE);
